...
public interface FileSystem {
     ...
     * @throws IOException Thrown if the file descriptor does not exist or is not open
     *                     (errno EBADF).
     */
     ...
     * @throws IllegalArgumentException Thrown if an invalid mode is specified.
     * @throws IOException              Thrown if the underlying system call returns an error code. The message
